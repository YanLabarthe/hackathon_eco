function Adaptateur({photo}){
   const adaptateur= {
      ...
      function onClick() {
        window.location.href = "https://www.apple.com/fr/shop/product/MC461Z/A/adaptateur-secteur-magsafe-60w-apple-pour-macbook-et-macbook-pro-13-pouces";
      }
    return (
        <>
        ...
        <div className="rounded-lg  m-0 shadow-lg flex bg-green-100">
          <div className="">
            ...
            <div className="flex-1 card-block relative">
              <div className="p-6">
                <h2 className="font medium text-3xl text-green-500 mb-3">{adaptateur.name}</h2>
